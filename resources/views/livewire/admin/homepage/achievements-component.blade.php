...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 font-weight-bold">Achievements</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="font-weight-bold float-left">All Achievements</h6>
                        ...
                        <div class="card-body">
                            ...
                            {{ $achievements->links('pagination-links') }}
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" wire:model="description"
                                            placeholder="Enter description" style="height: 120px;"></textarea>
                                        @error('description')
                                            <span class="text-danger"
                                                style="font-size: 12.5px;">{{ $message }}</span>
                                        @enderror
    ...
    <div wire:ignore.self class="modal fade" id="editModal" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-weight-bold">Edit Facility</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                        wire:click="close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                            ...
                            <form wire:submit.prevent="updateData">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <button class="btn btn-sm btn-danger ml-2" data-dismiss="modal"
