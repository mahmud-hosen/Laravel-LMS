...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 font-weight-bold">Alumni</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="font-weight-bold float-left">Alumnies</h6>
                        ...
                        <div class="card-body">
                            ...
                            {{ $alumnies->links('pagination-links') }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-weight-bold">Add New Alumni</h6>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <form wire:submit.prevent="storeData">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 font-weight-normal">Designation</label>
                                    <div class="col-sm-9">
                                        <select class="form-control" wire:model="designation">
                                            <option value="">-- Select --</option>
                                            <option value="Ex-Principal">Ex-Principal</option>
                                            <option value="Ex-VicePrincipal">Ex-VicePrincipal</option>
    ...
    <div wire:ignore.self class="modal fade" id="editModal" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-weight-bold">Edit Alumni</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                        wire:click="close">
                        <span aria-hidden="true">&times;</span>
                    </button>
