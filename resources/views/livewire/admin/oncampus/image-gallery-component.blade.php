...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 font-weight-bold">On Campus</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="font-weight-bold float-left">All Image Galleries</h6>
                                        ...
                                        @if ($galleries->count() > 0)
                                            @foreach ($galleries as $item)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{ totalImage($item->id) }}</td>
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right" role="menu"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.galleryImages', ['id' => $item->id]) }}"><i
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-weight-bold">Add New Gallery</h6>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <form wire:submit.prevent="storeData">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 font-weight-normal">Description</label>
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" wire:model="description"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        @elseif($uploadedImage != '')
                                            <img src="{{ asset('uploads/all') }}/{{ $uploadedImage }}" width="120"
                                                class="mt-2 mb-2" />
                                        @endif
                                    </div>
                                </div>
    ...
    <div wire:ignore.self class="modal fade" id="editModal" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-weight-bold">Edit Gallery</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                        wire:click="close">
                        <span aria-hidden="true">&times;</span>
                    </button>
