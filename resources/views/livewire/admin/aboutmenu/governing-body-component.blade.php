...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 font-weight-bold">Governing Body</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="font-weight-bold float-left">Governing Body</h6>
                                        ...
                                        @if ($lists->count() > 0)
                                            @foreach ($lists as $item)
                                                <tr>
                                                    ...
                                                    <td style="width: 6%;">
                                                        <input type="number" class="form-control text-center slno"
                                                            id="slno" data-id="{{ $item->id }}"
                                                            value="{{ $item->serial }}" />
                                                    </td>
                                                    <td>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <form wire:submit.prevent="updateData">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-sm-3">Image <small
                                            class="text-muted">(Size:120x94)</small></label>
                                    <div class="col-sm-8">
                                        <input type="file" class="form-control" wire:model="image"
                                            style="padding: 5px; font-size: 13.5px;" />
