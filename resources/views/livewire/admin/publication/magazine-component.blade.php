...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5 class="m-0 font-weight-bold">Magazine</h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h6 class="font-weight-bold float-left">All Magazines</h6>
                                ...
                                <table class="table table-bordered" style="font-size: 13.5px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Image</th>
                                            <th>Title</th>
                                            <th>Magazine Link (Google Drive)</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-weight-bold">Add New Magazine</h6>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <form wire:submit.prevent="storeData">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 font-weight-normal">Magazine Link <br>
                                        <small>(Google Drive)</small></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-sm-3 font-weight-normal">Cover Image</label>
                                    <div class="col-sm-8">
