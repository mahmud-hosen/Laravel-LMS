...
class FacultyCollegeComponent extends Component
{
    ...
    public function editData($id)
    {
        ...
        $data = FacultyCollege::where('id', $id)->first();
        $this->name = $data->name;
    ...
    public function updateData()
    {
        ...
        $data = FacultyCollege::where('id', $this->data_id)->first();
        $data->name = $this->name;
        $data->designation = $this->designation;
    ...
    {
        $link = FacultyCollege::where('id', $this->delete_id)->first();
        $link->delete();
    ...
    {
        $faculties = FacultyCollege::where('name', 'like', '%' . $this->searchTerm . '%')->orWhere('designation', 'like', '%' . $this->searchTerm . '%')->paginate($this->sortingValue);

        return view('livewire.admin.faculty.faculty-college-component', ['faculties' => $faculties])->layout('livewire.admin.layouts.base');
    }
}
