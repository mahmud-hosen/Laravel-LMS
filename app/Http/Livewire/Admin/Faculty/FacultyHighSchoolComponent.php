...
class FacultyHighSchoolComponent extends Component
{
    ...
    public function editData($id)
    {
        ...
        $data = FacultyHighSchool::where('id', $id)->first();
        $this->name = $data->name;
    ...
    public function updateData()
    {
        ...
        $data = FacultyHighSchool::where('id', $this->data_id)->first();
        $data->name = $this->name;
        $data->designation = $this->designation;
    ...
    {
        $link = FacultyHighSchool::where('id', $this->delete_id)->first();
        $link->delete();
    ...
    {
        $faculties = FacultyHighSchool::where('name', 'like', '%' . $this->searchTerm . '%')->orWhere('designation', 'like', '%' . $this->searchTerm . '%')->paginate($this->sortingValue);

        return view('livewire.admin.faculty.faculty-high-school-component', ['faculties' => $faculties])->layout('livewire.admin.layouts.base');
    }
}
