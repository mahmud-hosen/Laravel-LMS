...
class FacultyPrimaryComponent extends Component
{
    ...
    public function editData($id)
    {
        ...
        $data = FacultyPrimary::where('id', $id)->first();
        $this->name = $data->name;
    ...
    public function updateData()
    {
        ...
        $data = FacultyPrimary::where('id', $this->data_id)->first();
        $data->name = $this->name;
        $data->designation = $this->designation;
    ...
    {
        $link = FacultyPrimary::where('id', $this->delete_id)->first();
        $link->delete();
    ...
    {
        $faculties = FacultyPrimary::where('name', 'like', '%' . $this->searchTerm . '%')->orWhere('designation', 'like', '%' . $this->searchTerm . '%')->paginate($this->sortingValue);

        return view('livewire.admin.faculty.faculty-primary-component', ['faculties' => $faculties])->layout('livewire.admin.layouts.base');
    }
}
